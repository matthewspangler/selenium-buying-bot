...
class WalmartBot(Bot):
    ...
    def sign_in(self):
        ...
        self.driver.find_element_by_xpath("//button[@id='hf-account-flyout']/span/span/span[2]").click()
        self.driver.find_element_by_xpath("//div[@id='vh-account-menu-root']/div[2]/div/a/div/span/div").click()
        self.driver.find_element_by_id("email").click()
        self.driver.find_element_by_id("email").clear()
        self.driver.find_element_by_id("email").send_keys(profile["email"])
    ...
    def do_checkout(self):
        profile = self.profile
        # Add to cart button
        self.driver.find_element_by_xpath("//div[@id='add-on-atc-container']/div/section/div/div[3]/button/span/span").click()
        # Check out button
        self.driver.find_element_by_xpath("//button[@data-tl-id='IPPacCheckOutBtnBottom']").click()
    ...
    def enter_shipping_info(self):
        ...
        self.driver.find_element_by_id("firstName").send_keys(profile["firstname"])
        self.driver.find_element_by_id("addressLineOne").click()
        self.driver.find_element_by_id("addressLineOne").clear()
        self.driver.find_element_by_id("addressLineOne").send_keys(profile["street"])
        self.driver.find_element_by_id("lastName").click()
        self.driver.find_element_by_id("lastName").clear()
        self.driver.find_element_by_id("lastName").send_keys(profile["lastname"])
        ...
        self.driver.find_element_by_xpath("//option[@value='%s']" % profile["state"]).click()
